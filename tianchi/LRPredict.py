...
trainData = numpy.loadtxt('/home/yeqing/train.txt', delimiter="\t")
testData = numpy.loadtxt('/home/yeqing/test.txt', delimiter="\t")
...
# with open('/home/yeqing/predict.csv', 'w') as myFile:
